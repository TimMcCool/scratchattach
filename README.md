...
```python
value = scratch3.get_var("project_id", "variable") #⚠️ Currently NOT WORKING because Scratch's clouddata logs are [down](https://scratch.mit.edu/discuss/topic/723110/) ⚠️
