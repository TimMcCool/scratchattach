...
class _SaCloudServer(BaseEventHandler):
    def __init__(self,
                hostname: str,
                *,
...
class TwCloudServer(_SaCloudServer, SimpleWebSocketServer):
    def __init__(
        self,
        hostname,
        *,
...
class TwSSLCloudServer(_SaCloudServer, SimpleSSLWebSocketServer):
    def __init__(
        self,
        hostname: str,
        *,
